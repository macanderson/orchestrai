...
class Settings(BaseSettings):
    ...
    # CORS
    CORS_ORIGINS: List[str] = ["http://localhost:3000", "https://docuchat.vercel.app"]
    ...
    # Database
    DATABASE_URL: str = os.environ.get("DATABASE_URL", "postgresql://postgres:postgres@localhost:5432/docuchat")
