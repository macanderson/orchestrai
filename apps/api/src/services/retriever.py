...
class DocumentRetriever:
    ...
    async def retrieve(self, query: str, project_id: str, top_k: int = 5) -> List[Dict[str, Any]]:
        ...
        # For simplicity in this prototype, we'll get all chunks and sort in Python
        # In production, this should use pgvector's cosine similarity directly
